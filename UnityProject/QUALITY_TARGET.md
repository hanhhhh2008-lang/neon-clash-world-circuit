...
- Readable full-body art for all 10 original fighters, with three costume treatments, an articulated primitive-mesh overlay for body/limb motion, and a persistent painted arena backdrop.
...
2. Replace the temporary primitive overlay with authored skinned meshes or sprite-bone rigs, then add multi-frame move animation, hitstop, cancel windows, throws, air attacks, richer VFX, audio, portraits, accessibility, and controller rebinding.
